...
use Fluent\JWTAuth\Test\Stubs\LaravelUserStub;

class JWTGuardTest extends AbstractTestCase
{
    /**
     * @var \Fluent\JWTAuth\JWT|\Mockery\MockInterface
     */
    protected $jwt;

    /**
     * @var \Fluent\Auth\Contracts\UserProviderInterface|\Mockery\MockInterface
     */
    protected $provider;

    /**
     * @var \Fluent\JWTAuth\JWTGuard|\Mockery\MockInterface
     */
    protected $guard;
    ...
    public function setUp(): void
    {
        ...
        $this->provider = Mockery::mock(UserModel::class);
        $this->guard = new JWTGuard($this->jwt, Services::request(), $this->provider,);
    }
    ...
    public function it_should_return_a_token_if_credentials_are_ok_and_user_is_found()
    {
        ...
        $this->provider->shouldReceive('findByCredentials')
                       ->once()
                       ->with($credentials)
                       ->andReturn($user);
    ...
    public function it_should_return_true_if_credentials_are_ok_and_user_is_found_when_choosing_not_to_login()
    {
        ...
        $this->assertTrue($this->guard->validate($credentials)); // once
    ...
    public function it_should_authenticate_the_user_by_id_and_return_boolean()
    {
        ...
        $this->assertTrue($this->guard->onceUsingId(1)); // twice
    }
    ...
    public function it_should_not_authenticate_the_user_by_id_and_return_false()
    {
        ...
        $this->assertFalse($this->guard->onceUsingId(1)); // twice
    }
