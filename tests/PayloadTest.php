...
use Mockery;
use Fluent\JWTAuth\Claims\Audience;
...
{
    /**
     * @var \Mockery\MockInterface|\Fluent\JWTAuth\Validators\PayloadValidator
     */
    protected $validator;

    /**
     * @var \Fluent\JWTAuth\Payload
     */
    protected $payload;
