...
namespace Fluent\JWTAuth\Test\Validators;
...
{
    /**
     * @var \Fluent\JWTAuth\Validators\TokenValidator
     */
    protected $validator;
    ...
    /**
     * @test
     * @dataProvider \Fluent\JWTAuth\Test\Validators\TokenValidatorTest::dataProviderMalformedTokens
     *
     * @param  string  $token
     */
    ...
    /**
     * @test
     * @dataProvider \Fluent\JWTAuth\Test\Validators\TokenValidatorTest::dataProviderTokensWithWrongSegmentsNumber
     */
