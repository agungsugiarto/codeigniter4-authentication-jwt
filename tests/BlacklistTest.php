...
{
    /**
     * @var \Fluent\JWTAuth\Contracts\Providers\Storage|\Mockery\MockInterface
     */
    protected $storage;

    /**
     * @var \Fluent\JWTAuth\Blacklist
     */
    protected $blacklist;

    /**
     * @var \Mockery\MockInterface|\Fluent\JWTAuth\Validators\Validator
     */
    protected $validator;
